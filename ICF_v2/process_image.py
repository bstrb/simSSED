...
def process_image(frame_number, image, masks, threshold, max_iters, step_size, n_steps, n_wedges, n_rad_bins, plot_profiles):
    """
    ...
    Parameters:
        ...
        plot_profiles (bool): Whether to plot the wedge profiles.
    ...
    center = find_diffraction_center(
        ...
        desired_threshold = None # np.percentile(image[masks], 90) # 90th percentile of intensity considered
